...
def test_list_datasets(mocker, mock_pennsieve):
    expected =  {'limit': 1, 'offset': 0, 'totalCount': 1, 'datasets': 
                [{'id': 2, 'sourceDatasetId': 3, 'name': 'dataset', 'description': 'description', 'ownerId': 4,
                'ownerFirstName': 'John', 'ownerLastName': 'Smith', 'ownerOrcid': '0000-0000-0000-0000',
                'organizationName': 'organization', 'organizationId': 1, 'license': 'license', 'tags': ['tag1', 'tag2'],
                'version': 5, 'revision': None, 'size': 6, 'modelCount': [{'modelName': 'model', 'count': 0}],
                'fileCount': 1, 'recordCount': 1, 'uri': 's3://pennsieve/1/1/', 'arn': 'arn:aws:s3:::pennsieve/1/1/',
                'status': 'PUBLISH_SUCCEEDED', 'doi': '10.00000/abc123', 'banner': 'https://pennsieve/banner',
                'readme': 'https://pennsieve/dataset-assets/1/1/readme.md', 'contributors': [{'firstName': 'John',
                'middleInitial': None, 'lastName': 'Smith', 'degree': None, 'orcid': '0000-0000-0000-0000'}],
                'collections': [{'id': 1, 'name': 'name'}], 'externalPublications': [{'doi': '10.0000/protocols.xx',
                'relationshipType': 'IsSupplementedBy'}], 'sponsorship': {'title': 'title', 'imageUrl': 'https://imageurl',
                'markup': 'markup'}, 'pennsieveSchemaVersion': '4.0', 'createdAt': '2000-12-12', 'updatedAt': '2000-12-12',
                'firstPublishedAt': '2000-12-12', 'versionPublishedAt': '2000-12-12', 'revisedAt': None, 'embargo': False,
                'embargoReleaseDate': None, 'embargoAccess': None}]}
